...
- **Enhancing Interpretability of Spiking Neural Networks for Classification of Brain Activity Data**, 2025.
- **Wykrywanie anomalii w strumieniach danych z wykorzystaniem impulsowej sieci neuronowej** (Anomaly detection in data streams using a spiking neural network), 2024.
- **Przewidywanie wartości zanieczyszczenia powietrza z wykorzystaniem zespołu głębokich sieci neuronowych** (Air pollution value prediction using an ensemble of deep neural networks), 2023.
- **Zastosowanie impulsowych sieci neuronowych do przewidywania zanieczyszczenia powietrza** (Application of spiking neural networks to air pollution prediction), 2023.
